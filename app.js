...
app.use(function(req, res, next) {
    res.header("Access-Control-Allow-Origin", ["https://fierce-caverns-88917.herokuapp.com", "http://localhost:3000"]); // update to match the domain you will make the request from
